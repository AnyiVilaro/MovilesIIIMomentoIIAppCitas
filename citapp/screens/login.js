...
function Login({ navigation }) {
  ...
  const getUser = async () => {
    ...
    try {
        const api_php = "http://192.168.0.3/citapp-api-php/login.php";
        const api_nodejs_mongo = "http://192.168.0.3:3000/api/validateuser"
  ...
  return (
    <View style={styles.loginScreenContainer}>
      <View style={styles.loginFormView}>
        <Text style={styles.logoText}>CitApp</Text>
